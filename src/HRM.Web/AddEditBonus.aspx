<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="AddEditBonus.aspx.cs" Inherits="AddEditBonus" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <section class="content-header">
        <h1 id="h1" runat="server"><%= hrmlang.GetString("addnewbonus")%><small></small></h1>
        <ol class="breadcrumb">
            <li><a href="Dashboard.aspx"><i class="fa fa-dashboard"></i> <%= hrmlang.GetString("home") %></a></li>
            <li class="active" id="LI1" runat="server"><%= hrmlang.GetString("addnewbonus")%></li>
        </ol>
    </section>
            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            <div class="form-group">
                                <label for="txtTitle"><%= hrmlang.GetString("title")%></label> <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtTitle"
                                    ErrorMessage="Required" CssClass="text-red"></asp:RequiredFieldValidator>                        
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="txtAmount"><%= hrmlang.GetString("amount")%></label> <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtAmount"
                                ErrorMessage="Required" CssClass="text-red"></asp:RequiredFieldValidator>                        
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="ctlCalendarBD"><%= hrmlang.GetString("bonusdate")%></label>                      
                            <uc1:ctlCalendar ID="ctlCalendarBD" runat="server" DefaultCalendarCulture="Grgorian" 

...
public partial class UserControls_ctlCalendar : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            string sLang = ("" + Session["LanguageId"] == "") ? "en-US" : "" + Session["LanguageId"];
            ...
            if (sLang != "en-US")
            {
                lblHijri.Text = hrmlang.GetString("hijri");
                lblGregorian.Text = hrmlang.GetString("gregorian");
                /*  ddlLocaleChoice.Items.Clear();
                  ddlLocaleChoice.Items.Add(new System.Web.UI.WebControls.ListItem(lblHijri.Text, "ar-SA"));
                  ddlLocaleChoice.Items.Add(new System.Web.UI.WebControls.ListItem(lblGregorian.Text, "en-US"));*/
                ddlLocaleChoice.SelectedValue = arabicCulture.Name;
            }
    ...
    private void Populate_Greg_Years_ddl()
    {
        ...
        int intYear;
        //added by sreedevi STARTS
        // ddlYear.Items.Clear();
        ddlYear.ClearSelection();
        //added by sreedevi ends
        ...
        ListItem lItem = ddlYear.Items.FindByValue(DateTime.Now.Year.ToString());
        if (lItem != null)

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="ManageEmployee.aspx.cs" Inherits="ManageEmployee" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <section class="content-header">
        <h1><asp:Literal ID="ltHdr" runat="server" Mode="PassThrough"></asp:Literal><small></small></h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="ddlBranch">
                                <%= hrmlang.GetString("branch") %></label><asp:CompareValidator ID="cmp0" runat="server"
                                    ControlToValidate="ddlBranch" Operator="NotEqual" Type="String" ValueToCompare="0"
                                    ValidationGroup="maingrp" ErrorMessage="Required" CssClass="text-red"></asp:CompareValidator>
                            <asp:DropDownList ID="ddlBranch" runat="server" CssClass="form-control" ValidationGroup="maingrp"
                                DataTextField="Branch" DataValueField="BranchID" AutoPostBack="true" OnSelectedIndexChanged="ddlBranch_SelectedIndexChanged">
                            </asp:DropDownList>
                        </div>
                        <div class="form-group">
                            <label for="ddlStatus">
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtBiometricId" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="ddlDept">
                                <%= hrmlang.GetString("maindepartment")%></label><asp:CompareValidator ID="CompareValidator1"
                                    runat="server" ControlToValidate="ddlDept" Operator="NotEqual" Type="String"
                                    ValueToCompare="0" ValidationGroup="maingrp" ErrorMessage="Required" CssClass="text-red"></asp:CompareValidator>
                            <asp:DropDownList ID="ddlDept" runat="server" CssClass="form-control" DataTextField="DepartmentName"
                                DataValueField="DepartmentID" ValidationGroup="maingrp" AutoPostBack="True" OnSelectedIndexChanged="ddlDept_SelectedIndexChanged">
                            </asp:DropDownList>
                        </div>
                        <div class="form-group">
                            <label for="ddlRole">
                                <%= hrmlang.GetString("role") %><asp:CompareValidator ID="CompareValidator2" runat="server"
                                    ControlToValidate="ddlRole" Operator="NotEqual" Type="String" ValueToCompare="0"
                                    ValidationGroup="maingrp" ErrorMessage="Required" CssClass="text-red"></asp:CompareValidator></label>
                            <asp:DropDownList ID="ddlRole" runat="server" CssClass="form-control" DataTextField="RoleName"
                                DataValueField="RoleID" ValidationGroup="maingrp">
                            </asp:DropDownList>
                        </div>
                        <div class="form-group">
                            <label for="txtUserID">
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtIrisId" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="ddlDesgn">
                                <%= hrmlang.GetString("designation")%><asp:CompareValidator ID="CompareValidator3"
                                    runat="server" ControlToValidate="ddlDesgn" Operator="NotEqual" Type="String"
                            ...
                            <asp:DropDownList ID="ddlDesgn" runat="server" CssClass="form-control" DataTextField="Designation"
                                DataValueField="DesignationID" ValidationGroup="maingrp">
                            </asp:DropDownList>
                        </div>
                        <div class="form-group">
        ...
        <div class="box box-primary">
            ...
            <div class="perheader">
                <h4>
                    <%= hrmlang.GetString("personaldetails")%></h4>
            </div>
            <div class="clearfix">
            </div>
            <div class="box-body personaldt">
                ...
                <div class="row rowmargin">
                    ...
                    <div class="col-xs-3">
                        <uc1:ctlDOB ID="ctlCalendardob" runat="server" DefaultCalendarCulture="Grgorian" MaxYearCountFromNow="0"
                ...
                <div class="row rowmargin">
                    ...
                    <div class="col-xs-3">
                        <asp:TextBox ID="txtIDDesc" runat="server" CssClass="form-control"></asp:TextBox>
                    </div>
                    <div class="col-xs-3">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body jobdetdt">
                <div class="row rowmargin">
                    <div class="col-xs-3">
                        <label for="ddlJobType">
                            <%= hrmlang.GetString("employmentstatus")%><asp:Label ID="lblNewStatus" runat="server"
                                CssClass="badge pull-right bg-green newstatus"></asp:Label>
                        </label>
                    </div>
                    <div class="col-xs-3">
                    ...
                    <div class="col-xs-3">
                        ...
                        <asp:TextBox ID="txtJoinDate" runat="server" CssClass="form-control dtjoin hrmhide"
                            placeholder="Joining Date"></asp:TextBox>
                    </div>
                    <div class="col-xs-3">
                        <uc2:ctlJoin ID="ctlCalProbStart" runat="server" DefaultCalendarCulture="Grgorian" MaxYearCountFromNow="0"
                            MinYearCountFromNow="-50" />
                        <asp:TextBox ID="txtProbStart" runat="server" CssClass="form-control dtprobstart hrmhide"
                            placeholder="Probation Start Date"></asp:TextBox>
                    </div>
                    <div class="col-xs-3">
                        <uc2:ctlJoin ID="ctlCalProbEnd" runat="server" DefaultCalendarCulture="Grgorian" MaxYearCountFromNow="5"
                            MinYearCountFromNow="-5" />
                        <asp:TextBox ID="txtProbEnd" runat="server" CssClass="form-control dtprobend hrmhide"
                            placeholder="Probation End Date"></asp:TextBox>
                    </div>
                </div>
            </div>
            <!-- /.box-body -->
        ...
        <div class="box box-primary">
            ...
            <div class="box-body bankdetdt">
                <div class="row rowmargin">
                    ...
                    <div class="col-xs-3">
                        <asp:TextBox ID="txtBranch" runat="server" CssClass="form-control" placeholder="Bank Branch"></asp:TextBox>
                    </div>
                    <div class="col-xs-3">
                        <asp:TextBox ID="txtAccNo" runat="server" CssClass="form-control" placeholder="Account No"></asp:TextBox>
                    </div>
                    <div class="col-xs-3">
                        <asp:TextBox ID="txtOther" runat="server" CssClass="form-control" placeholder="Other Details"></asp:TextBox>
                    </div>
                </div>
            </div>
            <!-- /.box-body -->
        ...
        <div class="box box-primary">
            ...
            <div class="box-body contactdt">
                <div class="row rowmargin">
                    ...
                    <div class="col-xs-3">
                        <asp:TextBox ID="txtAdd1" runat="server" CssClass="form-control validate" placeholder="Address Line 1"></asp:TextBox>
                    </div>
                    <div class="col-xs-3">
            ...
            <div class="box-body emgcydt">
                <div class="row rowmargin">
                    <div class="f-right col-xs-1">
                        <asp:Label ID="lblAddEmg" runat="server" CssClass="btn btn-success btn-sm newemg"></asp:Label>
                    </div>
                    <div class="clearfix">
                    </div>
                    <div class="col-xs-12">
                        <asp:GridView ID="gvEmg" runat="server" AutoGenerateColumns="false" OnRowCommand="gvEmg_RowCommand"
                            OnRowDataBound="gvEmg_RowDataBound" CssClass="table table-bordered table-striped dataTable"
                            Width="100%">
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        ...
                                        <asp:LinkButton ID="lnkDelete" runat="server" CssClass="fa fa-trash-o" CommandArgument='<%# Eval("EmgContactID") %>'
                                            CommandName="DEL" OnClientClick="return confirm('Are you sure to delete this Contact?')"
                ...
                <div class="row rowmargin">
                    ...
                    <div class="col-xs-12">
                        <asp:GridView ID="gvDependent" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-striped dataTable"
                            Width="100%" OnRowCommand="gvDependent_RowCommand" OnRowDataBound="gvDependent_RowDataBound">
                            <Columns>
            ...
            <div class="box-body educationdt">
                <div class="row rowmargin">
                    <div class="f-right col-xs-3">
                        <asp:Label ID="Label1" runat="server" CssClass="btn btn-success btn-sm newedulevel"><%= hrmlang.GetString("addeducationlevel")%></asp:Label>&nbsp;<asp:Label
                            ID="lblAdAlwu" runat="server" CssClass="btn btn-success btn-sm newedu"></asp:Label>
                    </div>
                    <div class="clearfix">
                    </div>
                    <div class="col-xs-12">
                        <asp:GridView ID="gvEducation" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-striped dataTable"
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        ...
                                        <asp:LinkButton ID="lnkDelete" runat="server" CssClass="fa fa-trash-o" CommandArgument='<%# Eval("EducationID") %>'
                                            CommandName="DEL" OnClientClick="return confirm('Are you sure to delete this Education Details?')"
                                            CausesValidation="false"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        ...
                        <asp:GridView ID="gvSkill" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-striped dataTable"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Comments">
                                    <ItemTemplate>
                                        <asp:Label ID="lblComm" runat="server" Text='<%# Eval("Comments") %>' Visible="false"></asp:Label>
                                        <asp:Label ID="lComm" runat="server" Visible='<%# (Eval("Comments").ToString().Length==0) ? false : true %>'
                                            Text='<%# (Eval("Comments").ToString().Length>30) ? Eval("Comments").ToString().Substring(0,30)+"..." : Eval("Comments") %>'></asp:Label>
                                        <a href="#" data-toggle="tooltip" title='<%# Eval("Comments") %>' id="lnkCom" runat="server"
                                            visible='<%# (Eval("Comments").ToString().Length==0 || Eval("Comments").ToString().Length < 30) ? false : true %>'>
                                            <%= hrmlang.GetString("more") %></a>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        ...
                                        <asp:LinkButton ID="lnkDelete" runat="server" CssClass="fa fa-trash-o" CommandArgument='<%# Eval("SkillID") %>'
                                            CommandName="DEL" OnClientClick="return confirm('Are you sure to delete this Skill?')"
                                            CausesValidation="false"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                ...
                <div class="row rowmargin">
                    ...
                    <div class="col-xs-12">
                        <asp:GridView ID="gvLang" runat="server" CssClass="table table-bordered table-striped dataTable"
                            AutoGenerateColumns="False" OnRowCommand="gvLang_RowCommand" OnRowDataBound="gvLang_RowDataBound">
                            <Columns>
        ...
        <div class="box-footer">
            <asp:Button ID="btnSave" runat="server" CssClass="btn btn-primary" ValidationGroup="maingrp"
                Text="Save" OnClick="btnSave_Click" OnClientClick="return validateempctrl();" />
    ...
    <div class="modal fade" id="emplstatus" tabindex="-1" role="dialog" aria-labelledby="basicModal"
        aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">
                        <%= hrmlang.GetString("employmentstatus")%></h4>
                </div>
                <div class="col-xs-8">
                    <label>
                        <%= hrmlang.GetString("description")%>
                        <asp:RequiredFieldValidator ID="rfvType" runat="server" ControlToValidate="txtType"
                            ValidationGroup="emplstatus" ErrorMessage="Required" ForeColor="Red"></asp:RequiredFieldValidator></label>
                </div>
                <div class="col-xs-8">
                    <asp:TextBox ID="txtType" runat="server" CssClass="form-control" placeholder="Employment Status"
                        ValidationGroup="emplstatus"></asp:TextBox>
                </div>
                <div class="clearfix">
                </div>
                <div class="modal-footer">
                    <asp:Button ID="btnSaveEmplStatus" runat="server" CssClass="btn btn-primary" Text="Add"
                        ValidationGroup="emplstatus" OnClick="btnSaveEmplStatus_Click" />
    ...
    <div class="modal fade" id="dvEduLevel" tabindex="-1" role="dialog" aria-labelledby="basicModal"
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="H8">
                        <%= hrmlang.GetString("educationlevel")%></h4>
                </div>
                <div class="col-xs-8">
                    <label>
                        <%= hrmlang.GetString("description")%>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtLevel"
                            ValidationGroup="edulevel" ErrorMessage="Required" ForeColor="Red"></asp:RequiredFieldValidator></label>
                </div>
                <div class="col-xs-8">
                    <asp:TextBox ID="txtLevel" runat="server" CssClass="form-control" ValidationGroup="edulevel"></asp:TextBox>
                </div>
                <div class="clearfix">
                </div>
                <div class="modal-footer">
                    <asp:Button ID="btnSaveLevel" runat="server" CssClass="btn btn-primary" ValidationGroup="edulevel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header rowmargin">
                    <div class="col-xs-7">
                        <label for="txtEmgName">
                            <%= hrmlang.GetString("name") %><asp:RequiredFieldValidator ID="rfvEmgName" runat="server"
                                ControlToValidate="txtEmgName" ValidationGroup="emgcn" ErrorMessage="Required"
                                ForeColor="Red"></asp:RequiredFieldValidator></label></div>
                    <div class="clearfix">
                    </div>
                    <div class="col-xs-7">
                        <asp:TextBox ID="txtEmgName" runat="server" CssClass="form-control"></asp:TextBox>
                    </div>
                    <div class="clearfix">
                    </div>
                    <div class="col-xs-7">
                    ...
                    <div class="col-xs-7">
                        <label for="txtEmgHPhone">
                            <%= hrmlang.GetString("homephone") %><asp:RequiredFieldValidator ID="rfvEmgHPhone"
                                runat="server" ControlToValidate="txtEmgHPhone" ValidationGroup="emgcn" ErrorMessage="Required"
                                ForeColor="Red"></asp:RequiredFieldValidator></label></div>
                    <div class="clearfix">
                    </div>
                    <div class="col-xs-7">
                ...
                <div class="modal-footer">
                    <asp:Button ID="btnSaveEmg" runat="server" CssClass="btn btn-primary" ValidationGroup="emgcn"
                        OnClick="btnSaveEmg_Click" />
                    <button type="button" class="btn btn-default" data-dismiss="modal">
                        <%= hrmlang.GetString("close") %></button>
                </div>
            </div>
    ...
    <div class="modal fade" id="dvdependent" tabindex="-1" role="dialog" aria-labelledby="basicModal"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="H2">
                        <%= hrmlang.GetString("adddependent")%></h4>
                </div>
                <div class="modal-header rowmargin">
                    <div class="col-xs-3">
                        <label for="txtDepName">
                            <%= hrmlang.GetString("name") %><asp:RequiredFieldValidator ID="rfvDepName" runat="server"
                                ControlToValidate="txtDepName" ValidationGroup="depgroup" ErrorMessage="Required"
                                ForeColor="Red"></asp:RequiredFieldValidator></label></div>
                    <div class="clearfix">
                    </div>
                    <div class="col-xs-7">
                        <asp:TextBox ID="txtDepName" runat="server" CssClass="form-control" ValidationGroup="depgroup"></asp:TextBox>
                    </div>
                    <div class="col-xs-7">
                        <label for="txtDepRelation">
                            <%= hrmlang.GetString("relationship") %><asp:RequiredFieldValidator ID="rfvRel" runat="server"
                                ControlToValidate="txtDepRelation" ValidationGroup="depgroup" ErrorMessage="Required"
                                ForeColor="Red"></asp:RequiredFieldValidator></label></div>
                    <div class="clearfix">
                    </div>
                    <div class="col-xs-7">
                    ...
                    <div class="col-xs-7">
                        <uc2:ctlJoin ID="ctlCalDepDob" runat="server" DefaultCalendarCulture="Grgorian" MaxYearCountFromNow="0"
                            MinYearCountFromNow="-80" />
                        <asp:TextBox ID="txtDepDob" runat="server" CssClass="form-control dtdepdob hrmhide"
                ...
                <div class="modal-footer">
                    <asp:Button ID="btnSaveDep" runat="server" CssClass="btn btn-primary" ValidationGroup="depgroup"
                        OnClick="btnSaveDep_Click" />
                    <button type="button" class="btn btn-default" data-dismiss="modal">
                        <%= hrmlang.GetString("close") %></button>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header rowmargin">
                    ...
                    <div class="col-xs-7">
                        <asp:DropDownList ID="ddlEduLevel" runat="server" CssClass="form-control" DataTextField="EduLevelName"
                    ...
                    <div class="col-xs-7">
                        ...
                        <asp:TextBox ID="txtStartDate" runat="server" CssClass="form-control dtedustart hrmhide"
                    ...
                    <div class="col-xs-7">
                        <uc2:ctlJoin ID="ctlCalEndDate" runat="server" DefaultCalendarCulture="Grgorian" MaxYearCountFromNow="5"
                            MinYearCountFromNow="-20" />
                        <asp:TextBox ID="txtEndDate" runat="server" CssClass="form-control dteduend hrmhide"
                ...
                <div class="modal-footer">
                    <asp:Button ID="btnSaveEdu" runat="server" CssClass="btn btn-primary" OnClick="btnSaveEdu_Click" />
                    <button type="button" class="btn btn-default" data-dismiss="modal">
                        <%= hrmlang.GetString("close") %></button>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-header rowmargin">
                    ...
                    <div class="col-xs-7">
                        ...
                        <asp:TextBox ID="txtFromDate" runat="server" CssClass="form-control dtexpfrom hrmhide"
                    ...
                    <div class="col-xs-7">
                        <uc2:ctlJoin ID="ctlCalToDate" runat="server" DefaultCalendarCulture="Grgorian" MaxYearCountFromNow="0"
                            MinYearCountFromNow="-25" />
                        <asp:TextBox ID="txtToDate" runat="server" CssClass="form-control dtexpto hrmhide"
                    ...
                    <div class="col-xs-9">
                        <asp:TextBox ID="txtComments" runat="server" CssClass="form-control" TextMode="MultiLine"
                            placeholder="Comments"></asp:TextBox>
                    </div>
                    <div class="clearfix">
                    </div>
                </div>
                ...
                <div class="modal-footer">
                    <asp:Button ID="btnSaveExp" runat="server" CssClass="btn btn-primary" OnClick="btnSaveExp_Click" />
                    <button type="button" class="btn btn-default" data-dismiss="modal">
                        <%= hrmlang.GetString("close")%></button>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header rowmargin">
                    ...
                    <div class="col-xs-9">
                        <asp:TextBox ID="txtSkillComments" runat="server" CssClass="form-control" TextMode="MultiLine"
                            placeholder="Comments"></asp:TextBox>
                    </div>
                    <div class="clearfix">
                    </div>
                ...
                <div class="modal-footer">
                    <asp:Button ID="btnSaveSkill" runat="server" CssClass="btn btn-primary" OnClick="btnSaveSkill_Click" />
                    <button type="button" class="btn btn-default" data-dismiss="modal">
                        <%= hrmlang.GetString("close") %></button>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header rowmargin">
                    ...
                    <div class="col-xs-9">
                        <asp:TextBox ID="txtLangComments" runat="server" CssClass="form-control" TextMode="MultiLine"
                            placeholder="Comments"></asp:TextBox>
                    </div>
                    <div class="clearfix">
                    </div>
                ...
                <div class="modal-footer">
                    <asp:Button ID="btnSaveLang" runat="server" CssClass="btn btn-primary" OnClick="btnSaveLang_Click" />
                    <button type="button" class="btn btn-default" data-dismiss="modal">
                        <%= hrmlang.GetString("close") %></button>
                </div>
            </div>
    ...
    <div class="modal fade" id="dvImmigration" tabindex="-1" role="dialog" aria-labelledby="basicModal"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header rowmargin">
                    ...
                    <div class="col-xs-7">
                        <uc2:ctlJoin ID="ctlCalIssueDate" runat="server" DefaultCalendarCulture="Grgorian" MaxYearCountFromNow="0"
                            MinYearCountFromNow="-25" />
                        <asp:TextBox ID="txtIssueDate" runat="server" CssClass="form-control dtissue hrmhide"
                    ...
                    <div class="col-xs-7">
                        <uc2:ctlJoin ID="ctlCalExpDate" runat="server" DefaultCalendarCulture="Grgorian" MaxYearCountFromNow="20"
                            MinYearCountFromNow="-25" />
                        <asp:TextBox ID="txtExpDate" runat="server" CssClass="form-control dtexpiry hrmhide"
                    ...
                    <div class="col-xs-7">
                        <asp:DropDownList ID="ddlIssueCountry" runat="server" CssClass="form-control" DataTextField="CountryName"
                            DataValueField="CountryID">
                        </asp:DropDownList>
                    </div>
                    <div class="col-xs-7">
                    ...
                    <div class="col-xs-7">
                        ...
                        <asp:TextBox ID="txtReviewdate" runat="server" CssClass="form-control dtreview hrmhide"
                            placeholder="Eligible Review Date"></asp:TextBox>
                    </div>
                    <div class="col-xs-7">
                    ...
                    <div class="col-xs-9">
                        <asp:TextBox ID="txtImmgComments" runat="server" CssClass="form-control" TextMode="MultiLine"
                            placeholder="Comments"></asp:TextBox>
                    </div>
                    <div class="clearfix">
                    </div>
                ...
                <div class="modal-footer">
                    <asp:Button ID="btnSaveImmg" runat="server" CssClass="btn btn-primary" ValidationGroup="immggroup" OnClick="btnSaveImmg_Click" />
                    <button type="button" class="btn btn-default" data-dismiss="modal">
                        <%= hrmlang.GetString("close") %></button>
                </div>
            </div>

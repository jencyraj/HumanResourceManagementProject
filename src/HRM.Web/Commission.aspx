<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Commission.aspx.cs" Inherits="Commission" %>
...
<script type="text/javascript">
    ...
    <section class="content-header">
        <h1><%= hrmlang.GetString("managecommission")%><small></small></h1>
        <ol class="breadcrumb">
            <li><a href="Dashboard.aspx"><i class="fa fa-dashboard"></i> <%= hrmlang.GetString("home") %></a></li>
            <li class="active"><%= hrmlang.GetString("managecommission")%></li>
        </ol>
    </section>
        ...
        <div class="box box-primary">
            <div class="box-body">
                    ...
                    <div style="margin:auto;float:left">
                        ...
                        <div style="margin:auto;float:left">
                            ...
                            <div style="margin:auto;float:left;padding-right:14px">
                                <asp:Button ID="btnNew" runat="server" CssClass="btn btn-success btn-sm" Text="New Commission" CausesValidation="false" onclick="btnNew_Click" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-mg-12 rowmargin">
                    <asp:GridView ID="gvCommission" runat="Server" AutoGenerateColumns="False" CssClass="table table-bordered table-striped dataTable"
                        DataKeyNames="CommissionId" EnableViewState="True" AllowPaging="true" PageSize="15" ShowHeaderWhenEmpty="true" 
                        OnPageIndexChanging="gvCommission_PageIndexChanging" OnRowCommand="gvCommission_RowCommand"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="CommissionDate" HeaderText="Commission Date" DataFormatString="{0:dd/MM/yyyy}" />
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:HyperLink ID="lnkEdit" runat="server" CssClass="fa fa-edit"
                                 NavigateUrl='<%# "~/AddEditCommission.aspx?id=" + Eval("CommissionId") %>' data-toggle="tooltip" title="Edit"></asp:HyperLink>
                                <asp:LinkButton ID="lnkDelete" runat="server" CssClass="fa fa-trash-o" CommandArgument='<%# Eval("CommissionId") %>'
                                    CommandName="DEL" OnClientClick="return confirm('Are you sure to delete this Commission?')" CausesValidation="false" data-toggle="tooltip" title="Delete"></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView> 

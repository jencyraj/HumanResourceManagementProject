...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
 ...
 <section class="content-header">
    <h1><%= hrmlang.GetString("Checklist") %><small></small></h1>
    <ol class="breadcrumb">
        <li><a href="Dashboard.aspx"><i class="fa fa-dashboard"></i> <%= hrmlang.GetString("home") %></a></li>
        <li class="active"><%= hrmlang.GetString("managechecklist") %></li>
    </ol>
</section>
        ...
        <div class="box-body">
            ...
            <div class="col-mg-12 rowmargin">
                <asp:GridView ID="gvRole" runat="Server" AutoGenerateColumns="False" CssClass="table table-bordered table-striped dataTable"
                    OnRowCommand="gvRole_RowCommand" DataKeyNames="Clid" 
                    ...
                    <Columns>
                        <asp:BoundField DataField="Description" HeaderText="ManageCheckList" />
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkEdit" runat="server" CssClass="fa fa-edit" CommandArgument='<%# Eval("Clid") %>'
                                    CommandName="EDITBR" CausesValidation="false" data-toggle="tooltip" title="Edit"></asp:LinkButton>
                                <asp:LinkButton ID="lnkDelete" runat="server" CssClass="fa fa-trash-o" CommandArgument='<%# Eval("Clid") %>'
            ...
            <asp:Panel ID="pnlNew" runat="server" Visible="false">
                ...
                <div class="row rowmargin">
                    <div class="col-xs-4">
                        <label for="txtRole">
                            <%= hrmlang.GetString("CheckList")%></label>
                    ...
                    <div class="col-xs-4">
                        <asp:TextBox ID="txtRole" runat="server" CssClass="form-control txtround" placeholder="Enter Role"></asp:TextBox>
                    </div>
                </div>
